...
```{r eeg, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='In addition to self-report and behavioral measures, researchers in psychology use physiological measures. An electroencephalograph (EEG) records electrical activity from the brain. *Image by ulrichw from Pixabay.*', fig.alt = 'Photograph taken from behind a person wearing a yellow EEG cap fitted with multiple electrodes, seated in front of a computer monitor displaying a blue screen.'}
knitr::include_graphics("images/measurement/eeg.jpeg")
```
...
```{r retest, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Test-retest correlation between two sets of scores of several college students on the Rosenberg self-esteem scale, given two times a week apart.', fig.alt = 'Scatterplot with Rosenberg Self-Esteem Scale scores at Time 1 on the x-axis (0 to 30) and scores at Time 2 on the y-axis (0 to 30), showing 21 data points. The points cluster along a diagonal from lower-left to upper-right, indicating a strong positive test-retest correlation -- students who scored higher at Time 1 tended to score higher again one week later.'}
...
plot(x, y, type = "p", xlab = "Score at Time 1", ylab = "Score at Time 2", ylim = c(0,30), xlim = c(0,30), pch = 19, col = "#117EA7")
...
```{r internal, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Split-half correlation between several college students’ scores on the even-numbered items and their scores on the odd-numbered items of the Rosenberg self-esteem scale.', fig.alt = 'Scatterplot with scores on even-numbered Rosenberg Self-Esteem Scale items on the x-axis (0 to 20) and scores on odd-numbered items on the y-axis (0 to 20), showing 18 data points in orange. The points cluster along a diagonal from lower-left to upper-right, indicating strong internal consistency — students who scored higher on the even-numbered items tended to score higher on the odd-numbered items as well.'}
y <- c(6,7,8,9,8,9,10,11,11,14,11,12,13,14,13,14,12,14)
x <- c(6,8,8,9,10,10,10,11,12,12,13,13,13,13,14,14,15,15)

plot(x, y, type = "p", xlab = "Score on Even-Numbered Items", ylab = "Score on Odd-Numbered Items", ylim = c(0,20), xlim = c(0,20), pch = 19, col = "#BC5C15")
grid(nx = NULL, ny = NULL,
     lty = 2,      # Grid line type
     col = "#7F7F7F40", # Grid line color
     lwd = 1)      # Grid line width
