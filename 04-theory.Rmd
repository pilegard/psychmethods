...
knitr::include_graphics("images/ch4/writing.jpeg")
```
...
knitr::include_graphics("images/ch4/memory.jpeg")
```
...
```{r g, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap='Representation of one theory of intelligence. In this theory of intelligence, a general mental ability (*g*) influences each of three more specific mental abilities. Theories of this type help to organize a large number of statistical relationships among tests of various mental abilities.'}
knitr::include_graphics("images/ch4/g.jpeg")
```
...
knitr::include_graphics("images/ch4/hypo.jpeg")
```
...
knitr::include_graphics("images/ch4/hypothetico.jpeg")
```
