...
```{r validity, echo = FALSE, out.width='90%', fig.align = 'center', fig.cap='Experiments are generally high in internal validity, quasi-experiments lower, and correlational studies lower still.'}
knitr::include_graphics("images/ch7/validity.png")
```
...
```{r timeseries, echo = FALSE, out.width='60%', fig.align = 'center',  fig.show = 'hold', fig.cap='Hypothetical interrupted time-series design. The top panel shows data that suggest that the treatment caused a reduction in absences. The bottom panel shows data that suggest that it did not.'}
