...
```{r validity, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Experiments are generally high in internal validity, quasi-experiments lower, and correlational studies lower still.'}
knitr::include_graphics("images/ch7/validity.jpeg")
```
...
knitr::include_graphics("images/ch7/todo.jpeg")
```
...
```{r eysenck, echo = FALSE, out.width='35%', fig.align = 'center', fig.cap='In a classic 1952 article, researcher Hans Eysenck pointed out the shortcomings of the simple pretest-posttest design for evaluating the effectiveness of psychotherapy. *Source: Sirswindon on Wikimedia Commons.*'}
knitr::include_graphics("images/ch7/eysenck.jpg")
```
:::
...
```{r timeseries, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Hypothetical interrupted time-series design. The top panel shows data that suggest that the treatment caused a reduction in absences. The bottom panel shows data that suggest that it did not.'}
knitr::include_graphics("images/ch7/timeseries.jpeg")
```
