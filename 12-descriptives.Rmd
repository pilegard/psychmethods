...
```{r variability, echo = FALSE, out.width='60%', fig.align = 'center', fig.show = 'hold', fig.cap='Histograms showing hypothetical distributions of 1,000 observations with the same mean, median, and mode (10) but with low variability (top) and high variability (bottom).'}
