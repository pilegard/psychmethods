...
```{r journals, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap='Small sample of the thousands of professional journals that publish research in psychology and related fields.', fig.alt = 'Five academic journals fanned out on a table, including Psychological Science, Child Development, American Psychologist, Behavior Therapy, and Personality and Social Psychology Bulletin.'}
