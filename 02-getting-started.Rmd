...
barplot(words, names.arg = c("Women","Men"), col = c("#1BADE3","#4E67C8"), xlab = "Sex", axis.lty=1, ylab = "Words Spoken per Day", ylim = c(0,20000))
```
...
knitr::include_graphics("images/ch2/pearson.png")
```
...
knitr::include_graphics("images/ch2/correlationdoesnotimplycausation.png")
```
