...
```{r vaccine, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='In 1998 a study linking the MMR vaccine to autism caused vaccination rates to drop and put children at higher risk of measles, mumps, and rubella. Subsequent research failed to find a statistical relationship between the vaccine and autism. *Photo by CDC on Unsplash.*', fig.alt = 'Photograph of a young child with their sleeve rolled up receiving a bandage on their upper arm from a smiling doctor, while a woman smiles warmly in the background.'}
knitr::include_graphics("images/ethics/vaccine.jpeg")
```
...
```{r ethics, echo = FALSE,}
principle<-c("Weighing risks against benefits","Acting responsibly and with integrity","Seeking justice","Respecting people’s rights and dignity")
participants<-c("","","","")
scientists<-c("","","","")
society<-c("","","","")
ethics<-data.frame(principle,participants,scientists,society)
knitr::kable(ethics, "pipe", col.name=c("Moral principle","Research participants","Scientific community","Society"), caption = 'A framework for thinking about ethical issues in scientific research')
```
...
```{r authorship, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='According to the APA Ethics Code, faculty advisers should discuss publication credit—who will be an author and the order of authors—with their student collaborators as early as possible in the research process. *Photo by Christina @ wocintechchat.com on Unsplash.*', fig.alt = 'Photograph of three women sitting together at a table in conversation, suggesting a professor meeting with students.'}
knitr::include_graphics("images/ethics/authorship.jpeg")
```
