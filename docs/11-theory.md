...
{\centering \includegraphics[width=0.4\linewidth,alt={Close-up photograph of a hand writing longhand in a notebook.}]{images/theory/writing} 
...
{\centering \includegraphics[width=0.75\linewidth,alt={Flowchart of a memory model. An arrow from the environment points to the sensory store, which feeds into the short-term store, which has a bidirectional arrow connecting it to the long-term store. All three stores have separate arrows pointing to the word "forgetting."}]{images/theory/memory} 
...
{\centering \includegraphics[width=0.45\linewidth,alt={Diagram illustrating Spearman's general intelligence factor. A box labeled g at the top points downward to three boxes representing specific abilities: numerical ability, spatial ability, and verbal ability.}]{images/theory/g} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={A path diagram showing predictors of health anxiety and hypochondriasis. Neuroticism points to attention to negative health information, which in turn points to health anxiety and hypochondriasis. An arrow from illness experience points to the path between neuroticism and attention to negative health information, and an arrow from effortful control points to the path between attention to negative health information and health anxiety and hypochondriasis.}]{images/theory/hypo} 
...
{\centering \includegraphics[width=0.75\linewidth,alt={A diagram combining the hypothetico-deductive method with the general model of scientific research in psychology, shown as two concentric cycles. The outer cycle moves clockwise through four stages: theory construction and revision, hypothesis derivation, hypothesis testing, and theory evaluation, which feeds back into theory construction. The inner cycle moves through five stages: research questions, empirical study, data analysis, conclusions, and research literature, which feeds back to research questions. The inner cycle also includes a loop back from conclusions to research literature. An external arrow labeled "informal observations/ practical problems" points inward to the research questions stage of the inner cycle.}]{images/theory/hypothetico} 
...
Among the very best hypotheses are those that distinguish between competing theories. For example, Norbert Schwarz and his colleagues considered two theories of how people make judgments about themselves, such as how assertive they are [@schwarz1991ease]. Both theories held that such judgments are based on relevant examples that people bring to mind. However, one theory was that people base their judgments on the number of examples they bring to mind and the other was that people base their judgments on how easily they bring those examples to mind. To test these theories, the researchers asked people to recall either six times when they were assertive (which is easy for most people) or 12 times (which is difficult for most people). Then they asked them to judge their own assertiveness. Note that the number-of-examples theory implies that people who recalled 12 examples should judge themselves to be more assertive because they recalled more examples, but the ease-of-examples theory implies that participants who recalled six examples should judge themselves as more assertive because recalling the examples was easier. Thus the two theories made opposite predictions so that only one of the predictions could be confirmed. The surprising result was that participants who recalled fewer examples judged themselves to be more assertive—providing particularly convincing evidence in favor of the ease-of-retrieval theory over the number-of-examples theory.
