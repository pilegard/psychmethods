...
{\centering \includegraphics[width=0.7\linewidth,alt={A table comparing three levels of method section organization in a research report. The simple method column includes Participants and Design and Procedure as combined subsections. The typical method column separates these into Participants, Design, and Procedure. The complex method column adds a fourth subsection, Materials, between Design and Procedure. Each cell contains example opening sentences illustrating the content of that subsection.}]{images/ch11/method} 
...
{\centering \includegraphics[width=0.65\linewidth,alt={Screenshot of an APA-style research paper showing the title page and abstract. The title page includes the paper title, author name, and institutional affiliation but no author note. The abstract appears on a separate page.}]{images/ch11/sample1} 
...
{\centering \includegraphics[width=0.65\linewidth,alt={Screenshot of an APA-style research paper showing the introduction and method sections. The introduction is headed with the full title of the paper rather than the word Introduction, and the method section begins immediately after the introduction ends on the same page.}]{images/ch11/sample2} 
...
{\centering \includegraphics[width=0.65\linewidth,alt={Screenshot of an APA-style research paper showing the results and discussion sections. The discussion section begins immediately after the results section ends on the same page.}]{images/ch11/sample3} 
...
{\centering \includegraphics[width=0.65\linewidth,alt={Screenshot of an APA-style research paper showing the references page followed by a figure. The references are formatted in APA style, and the figure appears on its own page after the references.}]{images/ch11/sample4} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={Photograph of a student presenting a research poster mounted on a wall at an academic conference poster session, gesturing toward the poster while a professor listens attentively. Both wear name tags and the room is crowded with other attendees in the background.}]{images/ch11/poster} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={Two example research poster layouts. The first layout has the abstract in the top left and the title and authors in the top right, with three columns below: the left column contains the introduction and method, the center column is divided into two narrower columns displaying tables, figures, and results, and the right column contains conclusions and references. The second layout has the title and authors spanning the full width at the top, with three columns below: the left column contains the introduction and method, the center column features a large figure prominently in the middle with a small acknowledgements section at the bottom, and the right column contains conclusions and references.}]{images/ch11/posterorg} 
