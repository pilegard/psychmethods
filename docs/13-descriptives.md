...
{\centering \includegraphics[width=0.7\linewidth,alt={Histogram showing the distribution of self-esteem scores with Self-Esteem on the x-axis (14 to 25) and Frequency on the y-axis. The distribution is roughly bell-shaped and slightly left-skewed, with the highest frequencies clustered around scores of 21 and 22 and lower frequencies at the extremes.}]{13-descriptives_files/figure-latex/hist-1} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Histogram showing a hypothetical bimodal distribution of Beck Depression Inventory scores, with score on the x-axis (0 to 70) and frequency on the y-axis. The distribution has two distinct peaks, one at lower scores around 15 and a larger one at higher scores around 55, with a valley of lower frequency scores in between.}]{13-descriptives_files/figure-latex/bimodal-1} 
...
{\centering \includegraphics[width=0.33\linewidth,alt={Three histograms illustrating different distribution shapes. The first (orange) is negatively skewed, with most scores clustered at the high end and a long tail extending to the left. The second (green) is symmetrical, with scores forming a balanced bell curve centered in the middle. The third (blue) is positively skewed, with most scores clustered at the low end and a long tail extending to the right.}]{13-descriptives_files/figure-latex/skew-1} \includegraphics[width=0.33\linewidth,alt={Three histograms illustrating different distribution shapes. The first (orange) is negatively skewed, with most scores clustered at the high end and a long tail extending to the left. The second (green) is symmetrical, with scores forming a balanced bell curve centered in the middle. The third (blue) is positively skewed, with most scores clustered at the low end and a long tail extending to the right.}]{13-descriptives_files/figure-latex/skew-2} \includegraphics[width=0.33\linewidth,alt={Three histograms illustrating different distribution shapes. The first (orange) is negatively skewed, with most scores clustered at the high end and a long tail extending to the left. The second (green) is symmetrical, with scores forming a balanced bell curve centered in the middle. The third (blue) is positively skewed, with most scores clustered at the low end and a long tail extending to the right.}]{13-descriptives_files/figure-latex/skew-3} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={Two histograms illustrating differences in variability. Both distributions have the same mean, median, and mode of 10, and the same y-axis scale (0 to 300). The top histogram (light blue) shows a narrow, tall distribution with low variability, with most scores clustered tightly around 10. The bottom histogram (green) shows a wider, flatter distribution with high variability, with scores spread broadly across the range.}]{13-descriptives_files/figure-latex/variability-1} \includegraphics[width=0.6\linewidth,alt={Two histograms illustrating differences in variability. Both distributions have the same mean, median, and mode of 10, and the same y-axis scale (0 to 300). The top histogram (light blue) shows a narrow, tall distribution with low variability, with most scores clustered tightly around 10. The bottom histogram (green) shows a wider, flatter distribution with high variability, with scores spread broadly across the range.}]{13-descriptives_files/figure-latex/variability-2} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Bar chart with Condition on the x-axis and Clinician Rating of Severity on the y-axis (0 to 8). The Education condition (light blue) shows a mean rating of approximately 4.83, the Exposure condition (dark blue) shows the lowest mean rating at approximately 3.47, and the Control condition (red) shows the highest mean rating at approximately 5.56.}]{13-descriptives_files/figure-latex/phobia-1} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={Photograph of a woman standing at the front of a room gesturing toward a wall covered in sticky notes, while four people seated at a table with laptops listen to her.}]{images/ch12/leader} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Line graph with Last Name Quartile on the x-axis (First through Fourth) and Response Time in z scores on the y-axis (-0.4 to 0.4). The line slopes downward from left to right, with the first quartile showing the fastest response times (positive z scores) and the fourth quartile showing the slowest (negative z scores), indicating that people with last names earlier in the alphabet respond more quickly to consumer offers.}]{13-descriptives_files/figure-latex/line-1} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Scatterplot with Rosenberg Self-Esteem Scale scores at Time 1 on the x-axis (0 to 30) and scores at Time 2 on the y-axis (0 to 30), showing 21 data points in green. The points cluster along a diagonal from lower-left to upper-right, indicating a strong positive correlation between scores taken one week apart.}]{13-descriptives_files/figure-latex/scatter2-1} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Scatterplot with Hours of Sleep Per Night on the x-axis (0 to 14) and Depression on the y-axis (0 to 12), with a smooth curved trend line. Depression scores are highest at very low sleep amounts, decrease as sleep increases toward a moderate amount, and then rise again at very high sleep amounts, illustrating a nonlinear U-shaped relationship.}]{13-descriptives_files/figure-latex/nonlinear2-1} 
...
{\centering \includegraphics[width=0.9\linewidth,alt={A number line ranging from -1 to +1 with scatterplot illustrations at five points: -1, -0.5, 0, +0.5, and +1. The scatterplots illustrate the appearance of correlations ranging from a perfect negative relationship at -1, through no relationship at 0, to a perfect positive relationship at +1.}]{images/ch12/pearson} 

}

\caption{Range of Pearson’s *r*, from −1.00 (strongest possible negative relationship), through 0 (no relationship), to +1.00 (strongest possible positive relationship)}(\#fig:pearson2)
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth,alt={Scatterplot with Age on the x-axis (0 to 100) and Enjoyment of Hip-Hop on the y-axis (0 to 10). Across the full range of ages, the data points show a strong negative correlation of r = -.77, with younger participants tending to enjoy hip-hop more than older participants. A blue rectangle highlights the data points for 18- to 24-year-olds, where scores are clustered at a similarly high level with no apparent correlation, illustrating how restricting the range of a variable can obscure an otherwise strong relationship.}]{13-descriptives_files/figure-latex/range-1} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={APA-style bar graph titled "Mean Clinician's Rating of Phobia Severity by Treatment." Three conditions are shown on the x-axis: Education, Exposure, and Control, with error bars representing the standard error of the mean. The Exposure condition has the lowest mean severity rating, the Education condition is intermediate, and the Control condition has the highest. A note below the figure reads: "Note. Error bars represent standard error of the mean."}]{images/ch12/apabar} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={APA-style line graph titled "Mean Response Time by the Alphabetical Position of Respondents' Names in Alphabet." Last name quartile (First through Fourth) is shown on the x-axis and response time in z scores on the y-axis. The line slopes downward from left to right, indicating faster response times for people with last names earlier in the alphabet. Error bars represent the standard error of the mean. A note below reads: "Note. Error bars are standard error of the mean. Response times are expressed as Z scores."}]{images/ch12/apaline} 
...
{\centering \includegraphics[width=0.55\linewidth,alt={APA-style scatterplot titled "Relationship Between Scores on the Rosenberg Self-Esteem Scale Taken on Two Occasions One Week Apart." Scores at Time 1 are on the x-axis and scores at Time 2 on the y-axis, with data points clustered along a dashed least squares regression line running from lower-left to upper-right, indicating a strong positive test-retest correlation. A note below reads: "Note. Plot includes least squares regression line. Pearson's r = .96."}]{images/ch12/apascatter} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={APA-style jitter plot titled "Mean Reaction Time by Condition." Two conditions, Compatible and Incompatible, are shown on the x-axis, with reaction time in milliseconds on the y-axis. Individual participant data points are shown as jittered dots for each condition, with mean values and 95\% confidence interval error bars overlaid. A note below reads: "Note. Error bars represent the 95\% confidence interval of the mean. Each dot corresponds to one participant's average reaction time."}]{images/ch12/apajitter} 
...
{\centering \includegraphics[width=0.65\linewidth,alt={APA-style table titled "Means and Standard Deviations of Intentions to Have Unprotected Sex and Attitudes Toward Unprotected Sex as a Function of Both Mood and Self-Esteem." The table shows means and standard deviations for two dependent variables, intentions and attitudes, broken down by self-esteem level (high and low) and mood (negative and positive).}]{images/ch12/apatable} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={APA-style correlation matrix table titled "Correlations Between Five Cognitive Variables and Age." Six measures are listed as both rows and columns: working memory, executive function, processing speed, vocabulary, episodic memory, and age. The upper triangle of the matrix is left blank and dashes appear on the diagonal, following APA formatting conventions for correlation matrices.}]{images/ch12/apamatrix} 
