...
Often, psychological studies are interested in manipulating multiple independent variables. For example, Gupta INSERT CITE were interested in a specific type of fatigue during a motor sequence task.  
