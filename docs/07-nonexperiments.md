...
<img src="images/ch7/validity.png" alt="Experiments are generally high in internal validity, quasi-experiments lower, and correlational studies lower still." width="90%" />
...
<div class="figure" style="text-align: center">
<img src="07-nonexperiments_files/figure-html/timeseries-1.png" alt="Hypothetical interrupted time-series design. The top panel shows data that suggest that the treatment caused a reduction in absences. The bottom panel shows data that suggest that it did not." width="60%" /><img src="07-nonexperiments_files/figure-html/timeseries-2.png" alt="Hypothetical interrupted time-series design. The top panel shows data that suggest that the treatment caused a reduction in absences. The bottom panel shows data that suggest that it did not." width="60%" />
