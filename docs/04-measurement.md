...
{\centering \includegraphics[width=0.5\linewidth,alt={Photograph taken from behind a person wearing a yellow EEG cap fitted with multiple electrodes, seated in front of a computer monitor displaying a blue screen.}]{images/measurement/eeg} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Scatterplot with Rosenberg Self-Esteem Scale scores at Time 1 on the x-axis (0 to 30) and scores at Time 2 on the y-axis (0 to 30), showing 21 data points. The points cluster along a diagonal from lower-left to upper-right, indicating a strong positive test-retest correlation -- students who scored higher at Time 1 tended to score higher again one week later.}]{04-measurement_files/figure-latex/retest-1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Scatterplot with scores on even-numbered Rosenberg Self-Esteem Scale items on the x-axis (0 to 20) and scores on odd-numbered items on the y-axis (0 to 20), showing 18 data points in orange. The points cluster along a diagonal from lower-left to upper-right, indicating strong internal consistency — students who scored higher on the even-numbered items tended to score higher on the odd-numbered items as well.}]{04-measurement_files/figure-latex/internal-1} 
