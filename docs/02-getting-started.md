...
:::fyi
##### Marr's Three Levels {-}
David Marr's three levels of analysis are a way to break down the study of complex systems like the brain into three simpler parts. Imagine you're trying to understand a computer program. The first level, called the "computational level," is like looking at what the program does and why it does it. It's about understanding its main goals and functions. The second level, called the "algorithmic level," is like looking at the step-by-step instructions the program uses to accomplish those goals. It's about figuring out the specific methods or algorithms it uses. The third level, called the "implementational level," is like looking at how the program is actually built, including the hardware and the nitty-gritty details of how it works. These three levels help researchers approach the study of complex systems like the brain from different angles to get a better overall picture of how they function.     
:::
...
{\centering \includegraphics[width=0.7\linewidth,alt={Bar chart with Sex Assigned at Birth on the x-axis and Words Spoken per Day on the y-axis (0 to 20,000). Women (blue) average approximately 16,215 words per day and men (dark blue) average approximately 15,669 words per day, showing a very small difference between the two groups.}]{02-getting-started_files/figure-latex/bargraph-1} 
...
{\centering \includegraphics[width=0.75\linewidth,alt={Scatterplot with Stress on the x-axis (0 to 25) and Physical Symptoms on the y-axis (0 to 10), showing 21 data points in blue with a positive correlation of r = .51. Higher stress scores tend to correspond with more physical symptoms. One data point is highlighted with a blue rectangle, representing a person with a stress score of 10 and 3 physical symptoms.}]{02-getting-started_files/figure-latex/scatter-1} 
...
{\centering \includegraphics[width=0.9\linewidth,alt={A number line ranging from -1 to +1 with scatterplot illustrations at five points: -1, -0.5, 0, +0.5, and +1. The scatterplots illustrate the appearance of correlations ranging from a perfect negative relationship at -1, through no relationship at 0, to a perfect positive relationship at +1.}]{images/getting-started/pearson} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Scatterplot with Hours of Sleep Per Night on the x-axis (0 to 14) and Depression on the y-axis (0 to 12), with a smooth curved trend line. Depression scores are highest at very low sleep amounts, decrease as sleep increases toward a moderate amount, and then rise again at very high sleep amounts, illustrating a nonlinear U-shaped relationship.}]{02-getting-started_files/figure-latex/nonlinear-1} 
...
{\centering \includegraphics[width=0.9\linewidth,alt={A colorful graphic in the style of a public service announcement, showing a rainbow arcing toward a star with the text "Correlation Does Not Imply Causation" overlaid.}]{images/getting-started/correlationdoesnotimplycausation} 
