...
{\centering \includegraphics[width=0.7\linewidth,alt={Bar chart showing memory performance (y-axis, 0 to 15) by mood condition (x-axis). The positive mood condition bar (blue) reaches approximately 14, and the negative mood condition bar (red) reaches approximately 8.5.}]{03-experiments_files/figure-latex/confound-1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Bar chart showing improvement scores (y-axis, 0 to 8) across three conditions. The treatment group (light blue) shows the highest improvement at approximately 7, followed by the placebo group (red) at approximately 5, and the no treatment group (blue) at approximately 3.}]{03-experiments_files/figure-latex/placebo-1} 
...
{\centering \includegraphics[width=0.5\linewidth,alt={Photograph of a rack of surgical instruments in focus in the foreground, with blurred figures in scrubs gathered around a surgical table visible in the background.}]{images/experiments/surgery} 
