...
{\centering \includegraphics[width=0.8\linewidth,alt={A t distribution curve with 24 degrees of freedom, showing density on the y-axis and t scores on the x-axis ranging from -3 to 3. Four vertical dashed lines mark the critical values for alpha = .05. The two red lines mark the two-tailed critical values at t = -2.064 and t = 2.064, and the two green lines mark the one-tailed critical values at t = -1.711 and t = 1.711.}]{14-inferentials_files/figure-latex/tdist-1} 

}

\caption{Distribution of *t* scores (with 24 degrees of freedom) when the null hypothesis is true. The red vertical lines represent the two-tailed critical values, and the green vertical lines the one-tailed critical values when α = .05.}(\#fig:tdist)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth,alt={An F distribution curve with 3 and 35 degrees of freedom, showing density on the y-axis and F ratio on the x-axis ranging from 0 to 8. The curve starts high, drops sharply, and tapers into a long right tail. A red dashed vertical line marks the critical value at F = 2.874, corresponding to alpha = .05.}]{14-inferentials_files/figure-latex/fdist-1} 

}

\caption{Distribution of *F* ratio with 3 and 35 degrees of freedom when the null hypothesis is true. The red vertical line represents the critical value when α is .05.}(\#fig:fdist)
\end{figure}
