...
knitr::include_graphics("images/ch8/garbage.jpeg")
```
...
```{r designtable, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap='Factorial design table representing a 2 x 2 factorial design.'}
knitr::include_graphics("images/ch8/designtable.jpeg")
```
...
```{r designtable2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap='Factorial design table representing a 2 x 2 x 2 factorial design.'}
knitr::include_graphics("images/ch8/designtable2.jpeg")
```
...
```{r plots, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Two ways to plot the results of a factorial experiment with two independent variables.'}
knitr::include_graphics("images/ch8/plots.jpeg")
```
...
```{r barinteractions, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap='Bar graphs showing three types of interactions. In the top panel, one independent variable has an effect at one level of the second independent variable but not at the other. In the middle panel, one independent variable has a stronger effect at one level of the second independent variable than at the other. In the bottom panel, one independent variable has the opposite effect at one level of the second independent variable than at the other.'}
knitr::include_graphics("images/ch8/barinteractions.jpeg")
```

```{r lineinteractions, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap='Line graphs showing three types of interactions. In the top panel, one independent variable has an effect at one level of the second independent variable but not at the other. In the middle panel, one independent variable has a stronger effect at one level of the second independent variable than at the other. In the bottom panel, one independent variable has the opposite effect at one level of the second independent variable than at the other.'}
knitr::include_graphics("images/ch8/lineinteractions.jpeg")
```
