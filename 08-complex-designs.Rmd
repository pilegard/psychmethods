...
knitr::include_graphics("images/ch8/designtable.png")
```
...
knitr::include_graphics("images/ch8/designtable2.png")
```
...
plot(x1, y11, type = "b", frame = FALSE, pch = 19, col = "#BC5C15", 
     xlab = NULL, ylab = NULL, xaxt='n', yaxt='n', ann=FALSE, ylim = c(3,30))
lines(x1, y12, pch = 15, col = "#429780", type = "b", lty = 2)
grid(nx = NULL, ny = NULL, lty = 2, col = "#7F7F7F40", lwd = 1)
...
plot(x2, y21, type = "b", frame = FALSE, pch = 19, col = "#BC5C15", 
     xlab = NULL, ylab = NULL, xaxt='n', yaxt='n', ann=FALSE, ylim = c(3,30))
lines(x2, y22, pch = 15, col = "#429780", type = "b", lty = 2)
grid(nx = NULL, ny = NULL, lty = 2, col = "#7F7F7F40", lwd = 1)
...
plot(x3, y31, type = "b", frame = FALSE, pch = 19, col = "#BC5C15", 
     xlab = NULL, ylab = NULL, xaxt='n', yaxt='n', ann=FALSE, ylim = c(3,30))
lines(x3, y32, pch = 15, col = "#429780", type = "b", lty = 2)
grid(nx = NULL, ny = NULL, lty = 2, col = "#7F7F7F40", lwd = 1)
```
