...
```{r scatter2, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Statistical relationship between several college students’ scores on the Rosenberg Self-Esteem Scale given on two occasions a week apart.'}
...
```{r nonlinear2, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Hypothetical nonlinear relationship between sleep and depression.'}
...
```{r pearson2, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Pearson’s *r* ranges from −1.00 (representing the strongest possible negative relationship), through 0 (representing no relationship), to +1.00 (representing the strongest possible positive relationship).'}
