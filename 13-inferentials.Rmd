...
knitr::include_graphics("images/ch13/tdist.jpeg")
```
...
```{r fdist, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Distribution of *F* ratio with 2 and 37 degrees of freedome when the null hypothesis is true. The red vertical line represents the critical value when α is .05.'}
knitr::include_graphics("images/ch13/fdist.jpeg")
```
...
knitr::include_graphics("images/ch13/errors.jpeg")
```
