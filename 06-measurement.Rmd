...
```{r big5, echo = FALSE, out.width='100%', fig.align = 'center', fig.cap='The Big Five Personality Dimensions'}
knitr::include_graphics("images/measurement/big5.png")
```
:::
...
```{r eeg, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='In addition to self-report and behavioral measures, researchers in psychology use physiological measures. An electroencephalograph (EEG) records electrical activity from the brain. *Image by ulrichw from Pixabay.*'}
...
```{r retest, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Test-retest correlation between two sets of scores of several college students on the Rosenberg self-esteem scale, given two times a week apart.'}
...
```{r internal, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Split-half correlation between several college students’ scores on the even-numbered items and their scores on the odd-numbered items of the Rosenberg self-esteem scale.'}
