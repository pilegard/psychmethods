...
```{r confound, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Hypothetical results from a study on the effect of mood on memory. Because IQ also differs across conditions, it is a confounding variable.'}
knitr::include_graphics("images/ch6/confound.jpeg")
```
...
knitr::include_graphics("images/ch6/placebo.jpeg")
```
