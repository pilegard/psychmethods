...
```{r sampling, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap='A sample of 10 selected from a population of 100.', fig.alt = 'A  circle on the left contains 100 human figures representing a population. A  circle on the right contains 10 human figures representing a sample. Arrows pointing from left to right indicate that the sample was selected from the population.'}
