...
```{r sample1, echo = FALSE, out.width='65%', fig.align = 'center', fig.cap='Title Page and Abstract. This paper does not include the author note on the title page. The abstract appears on its own page.'}
knitr::include_graphics("images/ch11/sample1.png")
```

```{r sample2, echo = FALSE, out.width='65%', fig.align = 'center', fig.cap='Introduction and Method. Note that the introduction is headed with the full title, and the method section begins immediately after the introduction ends.'}
knitr::include_graphics("images/ch11/sample2.png")
```

```{r sample3, echo = FALSE, out.width='65%', fig.align = 'center', fig.cap='Results and Discussion. The discussion begins immediately after the results section ends.'}
knitr::include_graphics("images/ch11/sample3.png")
```

```{r sample4, echo = FALSE, out.width='65%', fig.align = 'center', fig.cap='References and Figure. If there were appendixes or tables, they would come before the figure.'}
