...
```{r teacher, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap='Single-subject research has shown that positive attention from a teacher for studying can increase studying and decrease disruptive behavior. *Photo by Jerry Wang on Unsplash.*', fig.alt = 'Photograph of a teacher crouching beside a young student, both looking attentively at a sheet of paper on the desk.'}
