...
knitr::include_graphics("images/ch10/teacher.jpeg")
```
...
```{r annao, echo = FALSE, out.width='30%', fig.align = 'center', fig.cap='“Anna O.” was the subject of a famous case study used by Freud to illustrate the principles of psychoanalysis. *Source: [Wikimedia Commons](http://en.wikipedia.org/wiki/File:Pappenheim_1882.jpg).*'}
knitr::include_graphics("images/ch10/annao.jpeg")
```
:::
...
```{r aba, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Results of a generic single-subject study illustrating several principles of single-subject research.'}
knitr::include_graphics("images/ch10/aba.jpeg")
```
...
```{r abab, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='An approximation of the results for Hall and colleagues’ participant Robbie in their ABAB reversal design.'}
knitr::include_graphics("images/ch10/abab.jpeg")
```
...
```{r multiple, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap='Results of a generic multiple-baseline study. The multiple baselines can be for different participants, dependent variables, or settings. The treatment is introduced at a different time on each baseline.'}
knitr::include_graphics("images/ch10/multiple.jpeg")
```
...
```{r aba2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap='Visual inspection of the data suggests an effective treatment in the top panel but an ineffective treatment in the bottom panel.'}
knitr::include_graphics("images/ch10/aba2.jpeg")
```
