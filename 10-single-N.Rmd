...
```{r abab, echo = FALSE, out.width='70%', fig.asp = .6, fig.align = 'center', fig.cap='An approximation of the results for Hall and colleagues’ participant Robbie in their ABAB reversal design.'}
x1 <- c(1,2,3,4,5,6,7)
